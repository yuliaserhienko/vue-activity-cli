<template>
  <article class="post">
    <div class="activity-title">
      ...
      <input v-model="updateActivities.title" type="text" class="input">
    </div>
    <div class="activity-category">
      <!-- TODO: add v-model and iterate categories in option  -->
      <select v-model="updateActivities.category" class="select">
    ...
    <div class="control activity-notes">
      ...
      <textarea v-model="updateActivities.notes"
                class="textarea"
    ...
    <div class="media">
      ...
      <div class="media-content">
        <div class="content">
          <p>
            <a href="#">Filip Jerga</a> updated {{ updateActivities.updatedAt | prettyTime }} &nbsp;
          </p>
        </div>
      </div>
      <div class="media-right">
        <!-- TODO: Add v-model here -->
        <input id="progress"
               v-model.number="updateActivities.progress"
               type="range"
               name="progress"
               min="0" max="100" value="90" step="10"
        >
        <label for="progress">{{ updateActivities.progress }} %</label>
      </div>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      updateActivity () {
        store.updateActivity(this.updateActivities)
          .then(() => {
